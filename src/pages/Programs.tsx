      ...
      <div className="max-w-6xl mx-auto">
        <div className={`flex flex-col ${isEven ? "lg:flex-row" : "lg:flex-row-reverse"} min-h-[70vh]`}>
          ...
          <motion.div
            ...
            className={`w-full lg:w-2/5 flex items-center justify-center p-10 md:p-16 relative ${
              isEven ? "bg-forest" : program.color === "gold" ? "bg-gold/10" : "bg-leaf/10"
            }`}
          >
            {/* Decorative rings */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 rounded-full border border-dashed border-foreground/[0.06]" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full border border-foreground/[0.04]" />
            ...
            <div className="relative z-10 text-center">
              ...
              >
                <program.icon
                  className={`w-14 h-14 ${program.color === "gold" ? "text-gold" : "text-leaf"}`}
                  strokeWidth={1.3}
                />
              </motion.div>
              ...
              <div className={`mt-4 font-display text-4xl md:text-5xl font-bold ${
          ...
          <motion.div
            ...
            className="w-full lg:w-3/5 p-8 md:p-16 flex flex-col justify-center"
          >
            ...
            <p className={`font-body text-lg leading-relaxed mb-6 max-w-lg ${
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              {program.highlights.map((h, hi) => (
                <motion.span
                  ...
                  className={`inline-flex items-center gap-1.5 text-xs font-body px-3 py-1.5 rounded-full ${
                    program.color === "gold"
            ...
            >
              <Link
                ...
                className={`inline-flex items-center gap-2 font-body font-semibold px-6 py-3 rounded-full transition-colors duration-300 ${
                  program.color === "gold"
