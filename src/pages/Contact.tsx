...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Optionally reset turnstile here if ref is added
    } catch (error) {
      console.error(error);
              ...
              <div className="lg:col-span-3">
                <div className="bg-forest-night rounded-2xl p-8 md:p-10">
                  ...
                  <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div className="pt-2">
                      <Turnstile
                        siteKey="0x4AAAAAACqyVFJuKdJvpGIu"
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 bg-gold text-accent-foreground font-body text-sm font-semibold py-3 rounded-lg hover:bg-gold-warm transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
