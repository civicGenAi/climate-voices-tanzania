...
const Footer = () => {
  ...
  const quickLinks = [
    ...
    { key: "footer.quickLinks.about", to: "/about" },
    { key: "footer.quickLinks.programs", to: "/programs" },
    { key: "footer.quickLinks.join", to: "/join" },
    { key: "footer.quickLinks.contact", to: "/contact" },
    { key: "footer.quickLinks.faq", to: "/faq" },
  ];

  const programLinks = [
    "footer.programs.education",
    "footer.programs.campaigns",
    "footer.programs.translation",
    "footer.programs.planting",
  ];
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
          <div className="col-span-2 sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="https://instagram.com/climatecardinalstz" target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-muted/30 border border-border flex items-center justify-center text-muted-foreground hover:text-gold hover:border-gold/40 transition-colors" aria-label="Instagram">
                <Instagram className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              </a>
              <a href="#" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-muted/30 border border-border flex items-center justify-center text-muted-foreground hover:text-gold hover:border-gold/40 transition-colors" aria-label="Twitter">
                <Twitter className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              </a>
              <a href="#" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-muted/30 border border-border flex items-center justify-center text-muted-foreground hover:text-gold hover:border-gold/40 transition-colors" aria-label="Facebook">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              {quickLinks.map((link) => (
                <li key={link.to}>
                  <Link to={link.to} className="font-body text-xs sm:text-sm text-muted-foreground hover:text-gold transition-colors duration-200">
                    {t(link.key)}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              {programLinks.map((key) => (
                <li key={key}>
                  <Link to="/programs" className="font-body text-xs sm:text-sm text-muted-foreground hover:text-gold transition-colors duration-200">
                    {t(key)}
                  </Link>
                </li>
              ))}
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li>
                <a href="tel:+255626700442" className="flex items-start gap-3 font-body text-xs sm:text-sm text-muted-foreground hover:text-gold transition-colors">
